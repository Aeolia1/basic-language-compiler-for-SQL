...
Refer to the syntax of SQL to implement the language compiler of the database. The function is similar to the basic SQL syntax, including create, update, select, etc. and compound logic processing;
